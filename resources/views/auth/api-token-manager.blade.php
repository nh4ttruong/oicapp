<div>
    ...
    <x-jet-form-section submit="createApiToken">
        ...
        <x-slot name="actions">
            <x-jet-button style="background-color: #e27db5; border-color: #5494d3">;
                {{ __('Create') }}
            </x-jet-button>
        </x-slot>
    </x-jet-form-section>
    ...
    <x-jet-dialog-modal wire:model="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-jet-button style="background-color: #e27db5; border-color: #5494d3" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-jet-button>
        </x-slot>
    </x-jet-dialog-modal>
