<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="d-flex mt-3">
            <x-jet-button style="background-color: #e27db5; border-color: #5494d3" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-button style="background-color: #e27db5; border-color: #5494d3" class="ms-2" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
