                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" value="{{ $event->introduction }}" style="height:50px" name="introduction"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                    <div class="form-group">
                                        <strong>Time:</strong>
                                        <input type="datetime-local" name="start_time" value="{{ $event->start_time }}" class="form-control" placeholder="dd/mm/yyyy" min="{{Carbon\Carbon::now()->firstOfYear()->format('d/m/Y')}}" max="{{Carbon\Carbon::now()->lastOfYear()->format('d/m/Y')}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center justify-content-center my-2" id="parent-preview-image">
                                    <img id="preview-image-before-upload" style="max-height: 450px; object-fit: fill;" src="/storage/{{ $event->image }}" >
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                    <div class="form-group">
                                        <strong>Image:</strong>
                                        <input type="file" accept="image/*" onchange="preview_image(event)" class="form-control" value="{{ $event->image }}" required name="image">
                                    </div>
                                </div>
